          ...
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column">
                <?php $name = explode(" ", esc_html($userdata->nama));?> 
                  ...
                  <div class="tabs">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane <?php if($tab=="detail_kk") echo "active";?>" id="detail_kk">
                        <br>
                       <form class="forms-sample" method="post" id="form_profil" action="<?php echo esc_attr(base_url('Penduduk/proses_edit_detail_kk'))?>">
                        <input type="hidden" name="no_kk" value="<?php echo esc_html($dataKK->no_kk)?>">
                        <div class="form-group">
                          <label for="no_kk">Nomor KK</label>
                          <input type="text" class="form-control" id="nomorKK"  placeholder="Nomor KK" onkeypress="return isNumber(event)" required="true" minlength="16" maxlength="16" value="<?php echo esc_html($dataKK->no_kk)?>" disabled>
                        </div>
                        <div class="form-group">
                          <label for="nik_kk">NIK Kepala Keluarga</label>
                          <input type="text" class="form-control" id="nik_kk_1" name="nik_kk" placeholder="NIK Kepala Keluarga" onkeypress="return isNumber(event)" required="true" minlength="16" maxlength="16" value="<?php echo esc_html($dataKK->nik_kepala_keluarga)?>">
                        </div>
                        <div class="form-group">
                          <label for="nama_kk">Nama Kepala Keluarga</label>
                          <input type="text" class="form-control" id="nama_kk_1" name="nama_kk" placeholder="Nama Kepala Keluarga" required="true" value="<?php echo esc_html($dataKK->nama)?>">
                        </div>
                        
                        <button type="submit" name="button_tambah_kk" class="btn btn-gradient-primary mr-2">Edit Detail KK</button>
                        <a href="<?php echo esc_url(base_url('Penduduk/kk'))?>" class="btn btn-gradient-danger">Kembali</a>
                      </form>
                      </div>
                      <div class="tab-pane <?php if($tab=="anggota_kk") echo "active";?>" id="anggota_kk">
                                ...
                                <?php 
                                  ...
                                  foreach ($dataAnggotaKeluarga as $anggota){?>
                                    <tr>
                                      ...
                                      <td><?php echo esc_html($anggota->NIK)?></td>
                                      <td><?php echo esc_html($anggota->nama)?></td>
                                      <td>
                                        <button type="button" class="btn btn-gradient-danger btn-rounded btn-icon" data-toggle="modal" data-target="#modal_hapus" onclick="deleteAnggota('<?php echo esc_html(base_url('Penduduk/hapus_anggota/'.$anggota->NIK.'_'.$dataKK->no_kk))?>')">
                          ...
                          <a href="<?php echo esc_url(base_url('Penduduk/kk'))?>" class="btn btn-gradient-danger">Kembali</a>
                          <form class="forms-sample" id="form_password" action="<?php echo esc_attr(base_url('Penduduk/tambah_anggota_kk_baru/'.$dataKK->no_kk))?>"  method="post">
