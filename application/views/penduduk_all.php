            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="<?php echo esc_url(base_url('Penduduk/pdf'))?>"class="btn btn-gradient-info mr-2" target="_blank">Print</a><br><br>
                      ...
                      <?php 
                        ...
                        foreach ($dataPenduduk as $penduduk){?>
                          <tr>
                            ...
                            <td><?php echo esc_html($penduduk->NIK)?></td>
                            <td><?php echo esc_html($penduduk->nama)?></td>
                            
                            <td>
                              <button type="button" class="btn btn-gradient-warning btn-rounded btn-icon btn-edit" data-toggle="modal" data-target="#editModal" id="<?php echo esc_attr($penduduk->NIK.'|'.$penduduk->nama) ?>">
                                <i class="mdi mdi-lead-pencil"></i>
                              </button>
                              <button type="button" class="btn btn-gradient-danger btn-rounded btn-icon" data-toggle="modal" data-target="#modal_hapus" onclick="deletePendduduk('<?php echo esc_js(base_url('Penduduk/hapus_penduduk/'.$penduduk->NIK))?>')">
...
<!-- Modals logout -->  
 ...
 <!-- Modal Edit-->
    <form action="<?php echo esc_attr(base_url('Penduduk/update'))?>" method="post">
