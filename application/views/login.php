...
<body>
  <div class="container-scroller" >
    <div class="container-fluid page-body-wrapper full-page-wrapper">
      <div class="content-wrapper d-flex align-items-center auth" style="background: url('<?php echo esc_attr(base_url())?>assets/image/banner_bg.jpg') no-repeat scroll center 0/cover">
        <div class="row w-100" >
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                <img src="<?php echo esc_url(base_url()); ?>assets_admin/images/logo.png">
              </div>
              <h4>Login</h4>

              <h6 class="font-weight-light">Masukkan username dan password</h6>
              <form class="pt-3" id="loginForm" action="<?php echo esc_attr(base_url('Login/login'))?>" method="post" >
                ...
                <?php
                  echo esc_html(show_err_msg($this->session->flashdata('error_msg')));
                ?>              
                <div class="mb-2">
                  <a class="btn btn-block btn-gradient-danger btn-lg font-weight-medium auth-form-btn" href="<?php echo esc_url(base_url())?>">Kembali ke Halaman Utama</a>
                </div>
              </form>
            </div>
          </div>
