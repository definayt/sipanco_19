        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Lapor Perjalanan Antar Kota</h2>
                    <ol class="breadcrumb">
        ...
        <section class="contact_area section_gap">
            <div class="container">
               <div class="section_title text-center">
                    <h4>Formulir Pelaporan Pasca Bepergian Antar Kota<br>Selama Pandemi COVID-19</h4>
                </div>
                <div class="row">
                   <div class="msg" style="display:none;">
                    ...
                    <div class="col-md-12 text-center">
                        <form class="row contact_form justify-content-center" action="<?php echo  esc_attr(base_url('Lapor/lapor'))?>" method="post" id="laporForm" novalidate="novalidate">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <div class="form-select" >
                                                    <select size="1" class="form-control select2" id="provinsi" name="provinsi" >
                                ...
                                <div id="filter_provinsi">
                                    <input type="hidden" class="form-control" placeholder="" name="kab_kota" value="">
                                </div>
                               <?php
                                    $today = date('Y-m-d');
       ...
       <!--================Contact Success and Error message Area =================-->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
              ...
              $("#provinsi").select2({
                 ajax: { 
                   url: '<?php echo esc_js(base_url()) ?>/Lapor/getProvinsi',
