    ...
    <body>
       ...
       <header class="header_area">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="<?php echo esc_url(base_url('Galeri')); ?>">Galeri</a></li>
                            <li class="nav-item submenu dropdown">
        ...
        <section class="breadcrumb_area">
            <div class="overlay bg-parallax" data-stellar-ratio="0.8" data-stellar-vertical-offset="0" data-background="" style="background: url('<?php echo  esc_html(base_url())?>assets/image/protokol_kesehatan_1.jpg') no-repeat scroll center 0/cover"></div>
            <div class="container">
                ...
                <div class="row imageGallery1" id="gallery">
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_01.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_01.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_02.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_02.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_03.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_03.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_04.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_04.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_05.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_05.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_06.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_06.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_07.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_07.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_08.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_08.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_09.jpeg" alt="">
                            <div class="hover">
                            	<a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_09.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_10.jpeg" alt="">
                            <div class="hover">
                                <a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_10.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_11.jpeg" alt="">
                            <div class="hover">
                                <a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_11.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_12.jpeg" alt="">
                            <div class="hover">
                                <a class="light" href="<?php echo esc_url(base_url()); ?>assets/image/gallery/gallery_12.jpeg"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
