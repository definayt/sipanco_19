            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="<?= base_url('Petugas/prosesEdit')?>">
                    <div class="form-group">
                      ...
                      <select  class="form-control select" id="nama_petugas" name="NIK" >
                        <option value="<?= $dataPetugas->NIK?>"><?= $dataPetugas->nama?></option>                          
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Username</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Masukkan Username Petugas" name="username" required="true" value="<?= $dataPetugas->username?>">
                    </div>
                    <div class="form-group">
                      <label>Role</label>
                        <select class="form-control"  name="role">
                          <option value="admin" <?php if($dataPetugas->role == 'admin') echo "selected";?>>Admin</option>
                          <option value="super_admin" <?php if($dataPetugas->role == 'super_admin') echo "selected";?>>Super Admin</option>
                        </select>
                      </div>
