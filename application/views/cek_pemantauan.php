...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                        ...
                        <div class="contact_info">
                            ...
                            <div class="info_item">
                                ...
                                <?php 
                                	...
                                	if($provinsi != '-') {?>
                                	<h6><?= $dataPemantauan->kota_kabupaten.', '.$provinsi.', '.$dataPemantauan->country_name; ?></h6>
                                <?php }else{?>
                                	<h6><?= $dataPemantauan->country_name; ?></h6>
                                <?php }?>
                                <p></p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="contact_info">
                            <div class="info_item">
                            	<?php
								  	$tanggal_mulai = tanggal(intval($dataPemantauan->tanggal_mulai[8].$dataPemantauan->tanggal_mulai[9]), intval($dataPemantauan->tanggal_mulai[5].$dataPemantauan->tanggal_mulai[6]), intval($dataPemantauan->tanggal_mulai[0].$dataPemantauan->tanggal_mulai[1].$dataPemantauan->tanggal_mulai[2].$dataPemantauan->tanggal_mulai[3]));
								  	$tanggal_selesai = tanggal(intval($dataPemantauan->tanggal_selesai[8].$dataPemantauan->tanggal_selesai[9]), intval($dataPemantauan->tanggal_selesai[5].$dataPemantauan->tanggal_selesai[6]), intval($dataPemantauan->tanggal_selesai[0].$dataPemantauan->tanggal_selesai[1].$dataPemantauan->tanggal_selesai[2].$dataPemantauan->tanggal_selesai[3]));
								  ?>
        ...
        <!-- </section>
        <section class="blog_categorie_area section_gap" > -->
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="categories_post">
                            <img src="<?= base_url(); ?>assets/image/protokol_kesehatan_1.jpg" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                                    <h3>Pemantauan Kesehatan Telah Berlangsung Selama</h3>
                                    <div class="border_line"></div>
                                    <h1><?= $dataPemantauan->pemantauan?></h1>
                                    <h3>Hari</h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="categories_post">
                            <img src="<?= base_url(); ?>assets/image/protokol_kesehatan.jpg" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                                    <h3>Sisa Masa Pemantauan</h3>
                                    <div class="border_line"></div>
                                    <h1><?= $dataPemantauan->sisa?></h1>
                                    <h3>Hari</h3>
                                </div>
                            </div>
                        </div>
