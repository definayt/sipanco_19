    ...
    <body>
       ...
       <header class="header_area">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="<?php echo esc_url(base_url('Tutorial')); ?>">Tutorial</a></li>
        ...
        <section class="breadcrumb_area">
            <div class="overlay bg-parallax" data-stellar-ratio="0.8" data-stellar-vertical-offset="0" data-background="" style="background: url('<?php echo esc_attr(base_url())?>assets/image/protokol_kesehatan_4.jpg') no-repeat scroll center 0/cover"></div>
            <div class="container">
                                    ...
                                    <div class="col-lg-7 mx-auto">
                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/dalam_negeri_1.png" class="col-lg-12">
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/dalam_negeri_2.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/dalam_negeri_3.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/dalam_negeri_4.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/dalam_negeri_5.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/dalam_negeri_6.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/dalam_negeri_7.png" class="col-lg-12">
                                            </li>
                                             <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/laporan_sukses.png" class="col-lg-12">
                                            </li>
                                        </ul><!-- End -->
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7 mx-auto">
                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/luar_negeri_1.png" class="col-lg-12">
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/luar_negeri_2.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 2</h2>
                                                <p class="text-small mt-2 font-weight-light">Setelah formulir pelaporan muncul, isikan NIK dan Nama Anda pada kolom NIK dan Nama</p>
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/luar_negeri_3.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 3</h2>
                                                 <p class="text-small mt-2 font-weight-light">Pilih negara yang terakhir Anda kunjungi pada masa pandemi Covid-19</p>
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/luar_negeri_4.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 4</h2>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/luar_negeri_5.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 5</h2>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/luar_negeri_6.png" class="col-lg-12">
                                            </li>
                                             <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 6</h2>
                                    ...
                                    <div class="col-lg-7 mx-auto">
                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/cek_pemantauan_1.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 2</h2>
                                                <p class="text-small mt-2 font-weight-light">Pastikan NIK yang Anda isikan sudah benar. Lalu tekan tombol "CEK"</p>
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/cek_pemantauan_2.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 3</h2>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/cek_pemantauan_3.png" class="col-lg-12">
                                            </li>
                                            <li class="timeline-item bg-white rounded ml-3 p-4 shadow">
                                                <div class="timeline-arrow"></div>
                                                <h2 class="h5 mb-0">Langkah 4</h2>
                                                ...
                                                <img src="<?php echo esc_url(base_url())?>assets/image/tutorial/cek_pemantauan_4.png" class="col-lg-12">
                                            </li>
                                        </ul><!-- End -->
                                    </div>
                                </div>
