            ...
            <nav aria-label="breadcrumb">
              <ul class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">
                  ...
                  <a href="<?php echo esc_url(base_url('Petugas/tambah'))?>" class="btn btn-gradient-primary mr-2"><i class="mdi mdi-plus-circle-outline icon-sm align-middle"></i>&Tab;Tambah Data Petugas</a>
                <?php }?>
                </li>
              </ul>
            </nav>
                      ...
                      <?php 
                        ...
                        foreach ($dataPetugas as $petugas){?>
                          <tr>
                            ...
                            <td><?php echo esc_html($petugas->nama)?></td>
                            <td><?php echo esc_html($petugas->username)?></td>
                            <?php if($petugas->role =='super_admin'){?>
                              <td><label class="badge badge-info"><?php echo esc_html($petugas->role)?></td>
                            <?php }else{?>
                              <td><?php echo esc_html($petugas->role)?></td>
                            <?php }?>
                            <?php if($userdata->role == 'super_admin'){?>
                            <td>
                              
                              <a href="<?php echo esc_url(base_url('Petugas/edit/'.$petugas->id))?>">
                                <button type="button" class="btn btn-gradient-warning btn-rounded btn-icon">
                                  <i class="mdi mdi-lead-pencil"></i>
                                </button>
                              </a>
                              <button type="button" class="btn btn-gradient-info btn-rounded btn-icon" data-toggle="modal" data-target="#modal_reset" onclick="resetPetugas('<?php echo esc_js(base_url('Petugas/reset_password/'.$petugas->id))?>')">
                                <i class="mdi mdi mdi-key-variant"></i>
                              </button>
                              <button type="button" class="btn btn-gradient-danger btn-rounded btn-icon" data-toggle="modal" data-target="#modal_hapus" onclick="deletePetugas('<?php echo esc_js(base_url('Petugas/hapus/'.$petugas->id))?>')">
