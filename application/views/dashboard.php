          ...
          <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                  <img src="<?= base_url(); ?>assets_admin/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image"/>
                  <h4 class="font-weight-normal mb-3">KK
                    <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5"><?= $jumlah_kk?></h2>
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                  ...
                  <h2 class="mb-5"><?= $jumlah_pelaporan?></h2>
                      ...
                      <?php }else{
                        ...
                        foreach ($pelaporan_terbaru as $pelaporan){?>
                          <tr>
                            ...
                            <?php $tanggal_mulai = tanggal(intval($pelaporan->tanggal_mulai[8].$pelaporan->tanggal_mulai[9]), intval($pelaporan->tanggal_mulai[5].$pelaporan->tanggal_mulai[6]), intval($pelaporan->tanggal_mulai[0].$pelaporan->tanggal_mulai[1].$pelaporan->tanggal_mulai[2].$pelaporan->tanggal_mulai[3])); ?>
                            <td><?= $tanggal_mulai?></td>
                            
                            <?php if($pelaporan->pemantauan <= 14){?>
                              <td><label class="badge badge-danger"><?= "Pemantauan Hari Ke-".$pelaporan->pemantauan?></td>
                            <?php }else{?>
