                          ...
                          <tr>
                           ...
                           <?php 
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn-gradient-danger btn-rounded btn-icon" data-toggle="modal" data-target="#modal_hapus" onclick="deletePelaporan('<?php echo esc_attr(base_url('Pelaporan/hapus/'.$pelaporan->id_pelaporan.'_'.$pelaporan->country_name))?>')">
  ...
  <script type="text/javascript">
    ...
    <script src="https://cdn.jsdelivr.net/npm/promise-polyfill@8/dist/polyfill.js"></script>
     <?php if ($this->session->flashdata('flash_message')): ?>
                      ...
                      Swal.fire({
                      title: "",
                      text: "<?php echo esc_js($this->session->flashdata('flash_message')); ?>",
                      timer: 10000,
